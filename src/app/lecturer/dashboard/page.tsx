      ...
      <div className={styles.container}>
        ...
        <div className={styles['stats-grid']}>
          ...
          <div className={`${styles['stat-card']} ${styles.purple}`}>
            ...
            <div className={`${styles['stat-icon-wrapper']} ${styles['stat-icon']}.purple`}>
              <svg
          ...
          <div className={`${styles['stat-card']} ${styles.pink}`}>
            <div>
              ...
              <div className={`${styles['stat-label']} ${styles.pink}`}>Pass Assignments</div>
            </div>
            <div className={`${styles['stat-icon-wrapper']} ${styles['stat-icon']}.pink`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
