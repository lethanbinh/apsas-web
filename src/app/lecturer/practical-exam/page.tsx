...
const PracticalExamPage = () => {
  ...
  const [selectedDate, setSelectedDate] = useState<Date | null>(new Date('2023-03-15')); // Example due date
    ...
    <div>
      <div className={styles.container}>
        ...
        <div className={styles['content-card']}>
          <h2 className={styles['assignment-title']}>PE 01 - Slot 01</h2>
          ...
          <div className={styles['date-info']} onClick={openDatePicker} style={{ cursor: 'pointer' }}>
            ...
            Due date: {selectedDate ? format(selectedDate, 'dd MMMM yyyy') : 'Select Date'}
          </div>
