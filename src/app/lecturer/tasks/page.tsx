    ...
    <div className={styles.container}>
      ...
      <div className={styles["task-section"]}>
        <div
          ...
          onClick={() => setIsCapstoneOpen(!isCapstoneOpen)}
        >
        ...
        {isCapstoneOpen && (
          ...
          >
            ...
            <div className={styles["sub-task-section"]}>
              <div
                className={styles["task-header"]}
                onClick={() => setIsAssignment01Open(!isAssignment01Open)}
              >
                <div className={styles["task-title"]}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <svg
                  className={`${styles["question-dropdown-arrow"]} ${
                    isAssignment01Open ? styles.rotate : ""
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                        ...
                        <div className={styles["question-content-wrapper"]}>
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              ...
                              onClick={() =>
                                setIsCriteria1Open(!isCriteria1Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 1
                              </h4>
                              <svg
                                className={`${
                                  styles["question-dropdown-arrow"]
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              className={styles["criteria-header"]}
                              onClick={() =>
                                setIsCriteria2Open(!isCriteria2Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 2
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              className={styles["criteria-header"]}
                              onClick={() =>
                                setIsCriteria3Open(!isCriteria3Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 3
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              className={styles["criteria-header"]}
                              onClick={() =>
                                setIsCriteria4Open(!isCriteria4Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 4
                        ...
                        <div className={styles["question-content-wrapper"]}>
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              className={styles["criteria-header"]}
                              onClick={() =>
                                setIsQ2Criteria1Open(!isQ2Criteria1Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 1
                        ...
                        <div className={styles["question-content-wrapper"]}>
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              className={styles["criteria-header"]}
                              onClick={() =>
                                setIsQ3Criteria1Open(!isQ3Criteria1Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 1
                        ...
                        <div className={styles["question-content-wrapper"]}>
                          ...
                          <div className={styles["criteria-sub-section"]}>
                            <div
                              className={styles["criteria-header"]}
                              onClick={() =>
                                setIsQ4Criteria1Open(!isQ4Criteria1Open)
                              }
                            >
                              <h4 className={styles["criteria-title-text"]}>
                                Criteria 1
            ...
            <div className={styles["sub-task-section"]}>
              <div
                className={styles["task-header"]}
                onClick={() => setIsAssignment02Open(!isAssignment02Open)}
              >
                <div className={styles["task-title"]}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <svg
                  className={`${styles["question-dropdown-arrow"]} ${
                    isAssignment02Open ? styles.rotate : ""
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              {isAssignment02Open && (
                ...
                >
                  ...
                  <p>
                    Details about Assignment 02 go here. You can add more
                    sections like Basic Assignment if needed.
                  </p>
                </div>
              )}
            </div>
      ...
      <div className={styles["task-section"]}>
        <div
          className={styles["task-header"]}
          onClick={() => setIsCapstoneProject2Open(!isCapstoneProject2Open)}
        >
          <div className={styles["task-title"]}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles["task-meta"]}>
            ...
            <svg
              className={`${styles["question-dropdown-arrow"]} ${
                isCapstoneProject2Open ? styles.rotate : ""
              }`}
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        {isCapstoneProject2Open && (
          ...
          >
            <p>
              Details for Capstone Project 2. This can contain nested
              assignments, questions, and criteria similar to Capstone Project 1
              if needed.
            </p>
          </div>
        )}
      ...
      <div className={styles["task-section"]}>
        <div
          className={styles["task-header"]}
          onClick={() => setIsCapstoneProject3Open(!isCapstoneProject3Open)}
        >
          <div className={styles["task-title"]}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles["task-meta"]}>
            ...
            <svg
              className={`${styles["question-dropdown-arrow"]} ${
                isCapstoneProject3Open ? styles.rotate : ""
              }`}
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        {isCapstoneProject3Open && (
          ...
          >
            <p>
              Details for Capstone Project 3. This can contain nested
              assignments, questions, and criteria similar to Capstone Project 1
              if needed.
            </p>
          </div>
